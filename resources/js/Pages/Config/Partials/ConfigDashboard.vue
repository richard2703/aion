                ...
                <div class="container mx-auto">
                    ...
                    <form @submit.prevent="submit" enctype="multipart/form-data">
                        <div class="grid grid-cols-1 gap-4">
                            <div>
                                <InputLabel for="nombre_negocio" value="Identidad del negocio: " />
                                <TextInput id="nombre_negocio" v-model="form.nombre_negocio" type="text"
                                    class="mt-1 block w-full" required autofocus autocomplete="nombre_negocio" />
                            </div>
                            <div>
