                    ...
                    <div class="mt-8">
                        ...
                        <table class="min-w-full divide-y divide-gray-200 mt-2">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr v-for="kpi in reportes[0].kpis" :key="kpi.concepto">
                                    <td class="px-6 py-4 whitespace-nowrap">{{ kpi.concepto }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">{{ kpi.valor }}%</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>

                    <!-- Proyectos/Avisos Section -->
                    <div class="mt-8">
                        <h2 class="text-xl font-bold text-purple-700">Proyectos, avisos parroquiales</h2>
                        <p class="mt-2">
                            {{ reportes[0].aviso }}
                        </p>
                    </div>
