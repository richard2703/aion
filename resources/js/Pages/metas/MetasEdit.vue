...
// const metaFlujo = ref(props.metaFlujo);
...
const treintas = ref(
    props.metaFlujo.treintas && props.metaFlujo.treintas.length
        ? props.metaFlujo.treintas.map(a => ({ value: a.meta }))
        : [{ value: "" }]
);

const sesentas = ref(
    props.metaFlujo.sesentas && props.metaFlujo.sesentas.length
        ? props.metaFlujo.sesentas.map(h => ({ value: h.meta }))
        : [{ value: "" }]
);

const noventas = ref(
    props.metaFlujo.noventas && props.metaFlujo.noventas.length
        ? props.metaFlujo.noventas.map(l => ({ value: l.meta }))
        : [{ value: "" }]
);
...
onMounted(() => {
    // console.log('metaFlujo', metaFlujo.value);
    getDepartamentos();
