                ...
                <div>
                    <div class="px-4 py-2 flex justify-end bg-white border-b border-gray-200">
                        <div v-if="userPermissions.includes('objetivos_crear')">
                            <PrimaryButton :href="route('objetivo.create')" class="m-4 pi pi-plus">
                                <span class="p-1"
                                    :style="{
                                        fontSize: '10px',
                                    }">
                    ...
                    <div class="px-4 py-2 bg-white border-b border-gray-200">
                        <div class="container mx-auto overflow-x-auto">
                            ...
                            <DataTable :value="items" paginator :rows="rows"
                                ...
                                :globalFilterFields="['id', 'objetivo', 'meta']" :sortField="sortField"
                                :sortOrder="sortOrder"
                                    ...
                                    <template #body="slotProps" class="text-center">
                                        <div class="flex justify-evenly">
                                            ...
                                            <div v-if="
                                                ...
                                                "
                                                class="inline">
                                                <PrimaryButton class="m-2 pi pi-trash"
                                                    @click.prevent="
                                                        deleteItems(
                                                            slotProps.data.id
                                                        )
