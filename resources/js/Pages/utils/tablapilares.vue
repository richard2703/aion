                ...
                <div class="px-4 py-2 bg-white border-b border-gray-200">
                    <div
                        ...
                        <div class="sm:col-span-1 lg:col-span-1">
                            ...
                            <DataTable :value="departamentos" paginator :rows="rows"
                                :totalRecords="totalRecords" :lazy="true" :first="first" @page="onPage"
                                @sort="onSort" :rowsPerPageOptions="[5, 10, 20, 50]" :filters="filters"
                                :globalFilterFields="[
                                    'nombre',
                                ]"
                        ...
                        <div class="sm:col-span-2 lg:col-span-2">
                            ...
                            <DataTable :value="procesos" paginator :rows="rows"
                                :totalRecords="totalRecords" :lazy="true" :first="first"
                                @page="onPage" @sort="onSort" :rowsPerPageOptions="[5, 10, 20, 50]"
                                :filters="filters"
                                :globalFilterFields="[
                                    'nombre',
                                ]"
                                ...
                                <Column field="link_externo" header="Link" headerStyle="width:4em;"
                                    ...
                                    <template #body="slotProps">
                                        <a :href="slotProps.data.link_externo" target="_blank"
                                            rel="noopener noreferrer">
                                            <PrimaryButton class="btn btn-primary btn-sm">Ir al archivo</PrimaryButton>
                                            <!-- <button class="btn btn-primary btn-sm">Ir al archivo</button> -->
                                        </a>
                                    </template>
                                </Column>
                            </DataTable>
                    ...
                    <div class="container mx-auto overflow-x-auto grid  grid-cols-1 sm:grid-cols-2 lg:grid-cols-2">
                        <div>
                            ...
                            <DataTable :value="procedimientos" paginator :rows="rows"
                                :totalRecords="totalRecords" :lazy="true" :first="first"
                                @page="onPage" @sort="onSort" :rowsPerPageOptions="[5, 10, 20, 50]"
                                :filters="filters"
                                :globalFilterFields="[
                                ...
                                <Column field="link_externo" header="Ejecución" headerStyle="width:4em;"
                                    ...
                                    <template #body="slotProps">
                                        <a :href="slotProps.data.link_herramienta" target="_blank"
                                            ...
                                            <PrimaryButton class="btn btn-primary btn-sm">Ir al Ejecución</PrimaryButton>
                                        </a>
                                    </template>
                                </Column>
                                <Column field="link_externo" header="Documentación" headerStyle="width:4em;"
                                    ...
                                    <template #body="slotProps">
                                        <a :href="slotProps.data.link_externo" target="_blank"
                                            rel="noopener noreferrer">
                                            <!-- {{ slotProps . data . link_externo }} -->
                                            <PrimaryButton class="btn btn-primary btn-sm">Ir al Documentación</PrimaryButton>
                                        </a>
                                    </template>
                                </Column>
                            </DataTable>
                        ...
                        <div>
                            ...
                            <DataTable :value="estandares" paginator :rows="rows"
                                :totalRecords="totalRecords" :lazy="true" :first="first"
                                @page="onPage" @sort="onSort" :rowsPerPageOptions="[5, 10, 20, 50]"
                                :filters="filters"
                                :globalFilterFields="[
