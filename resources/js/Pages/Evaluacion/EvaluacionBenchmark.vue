...
function setClass(nota) {
    if (nota >= 0 && nota < 21) {
        return evaluacionClass.value = 'px-1 content-centertext-white';
            ...
            <div class="bg-white overflow-hidden">
                <div class="border-gray-200 bg-white">
                    ...
                    <div class="gap-5 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
                        ...
                        <!-- colum 1 -->
                        <div class="p-2 border rounded h-[450px] max-h-[600px] overflow-scroll">
                            <div>
                                <div class="my-2 pl-2 font-semibold text-gray-800">LO QUE TE DUELE</div>
                        ...
                        <!-- colum 2 -->
                        <div class="p-2 border rounded h-[450px] max-h-[600px] overflow-scroll">
                            <div class="my-2 pl-2 font-semibold text-gray-800"> A GRAN NIVEL</div>
                        ...
                        <div class="p-2 border h-[450px] max-h-[600px] overflow-scroll rouded">
                            <div>
                                <div class="my-2 pl-2 font-semibold text-gray-800">EN DONDE ESTÁS</div>
