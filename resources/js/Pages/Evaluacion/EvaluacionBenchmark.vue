        ...
        <div class="py-2">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <!-- R3 -->
                    <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3  gap-2">
                        <div class="border p-1 rounded grid-cols-2 flex">
                            <div class="w-1/2">
                                <p class="text-sm p-1 text-justify bg-red-800 text-white">
                                    INICAL.- La oportunidad es grande para mejorar, todo lo que hagas con un sistema de
                                    excelencia operacional dará un gran beneficio en tu organización.
                                </p>
                                <p class="text-sm p-1 text-justify bg-red-500 text-white">
                                ...
                                <p class="text-sm p-1 text-justify bg-yellow-800 text-white">
                                ...
                                <p class="text-sm p-1 text-justify bg-green-800 text-white">
                                    AVANZADO :Momento de dar un brinco a la tecnología, si tus procesos ya son estables
                                    será el momento idóneo para comenzar a evaluar el fase 2 de un sistema de exclencia
                                    operacional
                                </p>
                                <p class="text-sm p-1 text-justify bg-blue-800 text-white">
                                    LÍDER : Eres un líder en tu ramo, usando todo tu potencial y listo para enfrentar
                                    los retos, evaluate en fase 2 de excelencia operacional, mejora de forma integrada
                                </p>

                            </div>
                            <div class="w-1/2">
                                <p class="text-sm p-1 text-justify">
                                    ...
                                    resultados de alta calidad y contribuir de manera más significativa al éxito global
                                    de la organización.
                                </p>
                            </div>
                        </div>
                        <div class="border p-1 rounded">
                            <p class="text-sm p-1 text-justify">
                                Primero se presentan los resultados de la evaluación del sistema de gestión, ya que este
                                es un componente crítico para la excelencia operacional. De hecho, gran parte de tu
                                calificación general depende de la puntuación en este elemento, ya que es fundamental
                                para desplegar todo el potencial de los demás elementos. A continuación, se muestran los
                                elementos de mejora continua, seguidos del resto de los pilares hasta llegar a la base:
                                el desarrollo y el aprendizaje.
                            </p>
                            <p class="text-sm p-1 text-justify">
                                Si tus resultados se encuentran debajo del 40% es un nivel esperado en la mayor parte de
                                empresas, si estás entre 40%-75% felicidades seguramente ya comenzaste con un programa
                                pero aún hace falta reforzar algunas prácticas, si estas por encima del 75% ¡es
                                increíble! estás con prácticas maduras y estás listo para involucrar nuevos conceptos
                                para el nivel 2 de iPMS® o de cualquier modelo de excelencia operacional.
                            </p>
                            <p class="text-sm p-1 text-justify">
                                Como notarás, todos los elementos evaluados son esenciales; todas las empresas y todos
                                los equipos, independientemente de su tipo, los requieren. Este es el fundamento sobre
                            ...
                            <ol class="list-decimal list-inside">
                                ...
                                <li>Asegurate de generar estándares basados en plataformas tecnológicas, es el futuro.
                                </li>
                            </ol>
                            </p>
                            <p class="text-sm p-1 text-justify">
                                Te invitamos a contactar a Productivity Center® e invertir 20 minutos de tu tiempo para
                                que te expliquemos de manera detallada el informe completo de tu autoevaluación el cual
                        ...
                        <div class="border p-1 rounded">
                            <p class="text-sm p-1 text-justify">
                                Este mapa te permite conocer tu nivel de madurez en prácticas de excelencia operacional
                            ...
                            <ul>
                                ...
                                <li class="text-yellow-800">INTERMEDIO.- Los procesos están optimizados y son impulsados
                                    por datos.</li>
                                <li class="text-green-800">AVANZADO.- Monitoreo sistemático y mejora de las métricas
                                    clave.</li>
                                <li class="text-blue-800">LÍDER.- Innovación continua y rendimiento líder en la
                                    industria.</li>
                            </ul>
                            </p>
                            <p class="text-sm p-1 text-justify">
                            ...
                            <ul>
                                <li><strong>Zona A.-</strong> Procesos sólidos, los resultados se logran mediante
                                    procesos automatizados, pero en la mayoría de los casos con poco trabajo en equipo o
                                ...
                                <li><strong>Zona B.-</strong> En camino hacia la mejora continua, organización
                                    ...
                                    zona, las posibilidades de lograr buenos avances en la excelencia operacional son
                                    altas.
                                </li>
                                <li><strong>Zona C.-</strong> Resultados a través de equipos con alta pasión, en la
                                    mayoría de los casos con poco seguimiento de procesos, organización más reactiva que
                                    planificada.
                                </li>
                            </ul>
                            </p>
                            <p class="text-sm p-1 text-justify">
                                ...
                                instrumento esencial para el crecimiento y desarrollo de tu organización. Cada resultado
                                obtenido puede brindarte una perspectiva y reflexión clara sobre qué áreas requieren
                                mejora. Sin embargo, la efectividad de las mejoras se potencia cuando estas se ejecutan
