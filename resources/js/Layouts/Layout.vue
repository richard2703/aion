        ...
        <div class="md:flex md:flex-col">
            <div class="md:flex md:flex-col md:h-screen">
                        ...
                        <dropdown class="mt-1 float-right" placement="bottom-end">
                            ...
                            <template #dropdown>
                                <div class="mt-2 py-2 text-sm bg-white rounded shadow-xl">
                                    ...
                                    <Link class="block px-6 py-2 hover:text-white hover:bg-neutral-500" href="/users">
                                    Manage Users</Link>
                ...
                <div class="md:flex md:grow md:overflow-hidden">
                    <main-menu class="hidden shrink-0 p-4 w-56 bg-neutral-800 overflow-y-auto md:block" />
