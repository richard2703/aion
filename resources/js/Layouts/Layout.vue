      ...
      <div class="md:flex md:flex-col">
        <div class="md:flex md:flex-col md:h-screen">
          <div class="md:flex md:shrink-0">
            <div class="flex items-center justify-between px-6 py-4 bg-neutral-900 md:shrink-0 md:justify-center md:w-56">
              ...
              <dropdown class="mt-1" placement="bottom-end">
                ...
                <template #dropdown>
                  <div class="mt-2 py-2 text-sm bg-white rounded shadow-xl">
                    <Link class="block px-6 py-2 hover:text-white hover:bg-neutral-500" :href="`/users/${$page.props.auth.user.id}/edit`">My Profile</Link>
                    <Link class="block px-6 py-2 hover:text-white hover:bg-neutral-500" href="/users">Manage Users</Link>
                    <Link class="block px-6 py-2 w-full text-left hover:text-white hover:bg-neutral-500" href="/logout" method="POST" as="button">Logout</Link>
                  </div>
                </template>
              </dropdown>
            </div>
          ...
          <div class="md:flex md:grow md:overflow-hidden">
            ...
            <div class="px-2 py-4 md:flex-1 md:p-4 md:overflow-y-auto bg-general" scroll-region >
              <flash-messages />
              <slot />
            </div>
          </div>
