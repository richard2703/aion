    ...
    <div class="lg:pl-72">
        ...
        <div class="flex justify-between flex-1 gap-x-4 self-stretch lg:gap-x-6">
            ...
            <div class="hidden lg:block lg:h-6 lg:w-px lg:bg-gray-900/10" aria-hidden="true"></div>
                <!-- Dropdown component-->
            <div class="relative">
                    <button type="button" class="-m-1.5 flex items-center p-1.5" id="user-menu-button" aria-expanded="false" aria-haspopup="true" onclick="toggleMenu()">
                    ...
                    <div id="user-menu" class="absolute right-0 z-10 mt-2.5 w-32 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 hidden" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button">
                        <a href="#" class="block px-3 py-1 text-sm text-gray-900" role="menuitem">Your profile</a>
                        <a href="#" class="block px-3 py-1 text-sm text-gray-900" role="menuitem">Sign out</a>
                    </div>
                </div>
            </div>
        </div>
